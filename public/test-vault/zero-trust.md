...
The model pairs naturally with [[confidential-computing]]: if you don't trust the network, you need a strong cryptographic basis for trusting the workload itself. Device posture, identity, and runtime integrity all become prerequisites for access.
